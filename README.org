...
** Implemented Midi Commands
 ...
 |---------+---------------------------+---------------------+----------------------------------------+--------------------------------------------|
 |    0x80 | Note-off                  | last note           | transpose around center note           | center note is 0x40 (note value: E4)       |
 |    0x90 | Note-on                   | note                | transpose around center note           | center note is 0x40 (note value: E4)       |
